...
class NotificationRestApi(object):
    ...
    def __init__(self, app=None):
                                    ...
                                    <pre>
        {
            ...
            def get_by_block(request, block):
            ...
            def get_by_addr(request, address):
                request.setHeader('Content-Type', 'application/json')
                try:
            ...
            def get_by_contract(request, contract_hash):
                request.setHeader('Content-Type', 'application/json')
                try:
            ...
            def get_token(request, contract_hash):
                request.setHeader('Content-Type', 'application/json')
                try:
