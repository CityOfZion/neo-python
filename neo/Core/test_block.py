...
class BlocksTestCase(unittest.TestCase):
    ...
    b2tx_realraw =  '0000d11f7a2800000000'
    b2tx_hex =      '0000d11f7a2800000000'
    b2tx_raw = b'\x00\x00\x00(z\x1f\xd1\x00\x80'

    def test_araw_block(self):

        hexdata = binascii.unhexlify(self.b2raw)

        block = AsSerializableWithType(hexdata, 'neo.Core.Block.Block')
