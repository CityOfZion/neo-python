...
from neo.Network.neonetwork.network.mempool import MemPool
...
class NodeManager(Singleton):
    ...
    async def start(self):
        ...
        task0 = asyncio.create_task(self.loop.create_server(proto, host, port))
        ...
        task1 = asyncio.create_task(self.handle_connection_queue())
        task2 = asyncio.create_task(self.query_peer_info())
        task3 = asyncio.create_task(self.ensure_full_node_pool())
